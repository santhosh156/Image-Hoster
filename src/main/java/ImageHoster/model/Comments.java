...
public class Comments {
    ...
    //One comment can be commented for only one image but one image can have multiple comments
    //FetchType is EAGER
    @ManyToOne(fetch = FetchType.EAGER)
    ...
    public Comments(String text, LocalDate date,User user,Image image) {
        this.setText(text);
        this.setDate(date);
        this.setUser(user);
        this.setImage(image);
