...
public class UserController {
    ...
    //Checks the password entered by the user to contain at least 1 alphabet (a-z or A-Z), 1 number (0-9) and 1 special character (any character other than a-z, A-Z and 0-9).
